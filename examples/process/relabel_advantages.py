...
classifier provenance, ensemble_size, etc. survive) and then overrides
...
def _parse_args(argv: Optional[list[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "the classifier hinge can push values slightly below -1, so the "
            "lower bound is a soft guideline — we raise only on "
